...
namespace MarkZither.KimaiDotNet.Models
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the ProjectExpanded class.
        /// </summary>
        public ProjectExpanded()
        {
            CustomInit();
        }
        ...
        /// #dd1d00</param>
        public ProjectExpanded(Customer customer, string name, bool visible, int? id = default(int?), string color = default(string))
        {
            Id = id;
            Customer = customer;
            Name = name;
