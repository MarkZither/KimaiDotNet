...
namespace MarkZither.KimaiDotNet.Models
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the UserCreateForm class.
        /// </summary>
        ...
        public UserCreateForm(string username, string email, string language, string timezone, string plainPassword, string alias = default(string), string title = default(string), string avatar = default(string), bool? enabled = default(bool?), IList<string> roles = default(IList<string>))
        {
            Username = username;
            Alias = alias;
            Title = title;
        ...
        /// <summary>
        /// Gets or sets plain text password
        /// </summary>
        [JsonProperty(PropertyName = "plainPassword")]
        ...
        public virtual void Validate()
        {
            ...
            {
                throw new ValidationException(ValidationRules.CannotBeNull, "PlainPassword");
            }
        }
    }
}
