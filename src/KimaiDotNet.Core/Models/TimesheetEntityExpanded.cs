...
namespace MarkZither.KimaiDotNet.Models
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the TimesheetEntityExpanded class.
        /// </summary>
        public TimesheetEntityExpanded()
        {
            CustomInit();
        }
        ...
        public TimesheetEntityExpanded(System.DateTime begin, ActivityExpanded activity, ProjectExpanded project, bool exported, int? user = default(int?), IList<string> tags = default(IList<string>), int? id = default(int?), System.DateTime? end = default(System.DateTime?), int? duration = default(int?), string description = default(string), double? rate = default(double?), double? internalRate = default(double?), double? fixedRate = default(double?), double? hourlyRate = default(double?), IList<TimesheetMeta> metaFields = default(IList<TimesheetMeta>))
        {
            User = user;
            Tags = tags;
            Id = id;
