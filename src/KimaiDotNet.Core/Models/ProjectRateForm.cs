...
namespace MarkZither.KimaiDotNet.Models
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the ProjectRateForm class.
        /// </summary>
        public ProjectRateForm()
        {
            CustomInit();
        }
        ...
        public ProjectRateForm(double rate, int? user = default(int?), double? internalRate = default(double?), bool? isFixed = default(bool?))
        {
            User = user;
            Rate = rate;
