...
namespace MarkZither.KimaiDotNet.Models
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the TimesheetCollection class.
        /// </summary>
        ...
        public TimesheetCollection(System.DateTime begin, int? activity = default(int?), int? project = default(int?), int? user = default(int?), IList<string> tags = default(IList<string>), int? id = default(int?), System.DateTime? end = default(System.DateTime?), int? duration = default(int?), string description = default(string), double? rate = default(double?), double? internalRate = default(double?), IList<TimesheetMeta> metaFields = default(IList<TimesheetMeta>))
        {
            Activity = activity;
            Project = project;
            User = user;
