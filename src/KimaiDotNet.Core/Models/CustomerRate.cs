...
namespace MarkZither.KimaiDotNet.Models
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the CustomerRate class.
        /// </summary>
        public CustomerRate()
        {
            CustomInit();
        ...
        /// Initializes a new instance of the CustomerRate class.
        /// </summary>
        public CustomerRate(bool isFixed, int? id = default(int?), User user = default(User), double? rate = default(double?), double? internalRate = default(double?))
        {
            Id = id;
            User = user;
            Rate = rate;
